...
if (import.meta.hot) {
  // (1) Edits to App.jsx (and its children that bubble up here) → hot-swap.
  import.meta.hot.accept("./App.jsx", (mod) => {
  ...
  // main.jsx has no accept boundary (it's the entry → nothing imports it),
